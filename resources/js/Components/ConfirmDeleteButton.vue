...
<template>
    <div class="text-sm flex items-center">
        <button
            ...
            class="text-white p-1 rounded-sm bg-red-600 hover:bg-red-700"
        >
            {{ buttonText }}
        </button>
        ...
        <div v-else class="flex items-center space-x-3">
            ...
            <button type="button" @click="destroy" class="text-white p-1 rounded-sm bg-red-600 hover:bg-red-700">Yes</button>
